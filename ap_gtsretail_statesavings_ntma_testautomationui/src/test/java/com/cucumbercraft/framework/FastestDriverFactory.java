        ...
        try {
            switch (testParameters.getMobileExecutionPlatform()) {
                ...
                case WEB_IOS:
                    ...
                    try {
                        driver = new IOSDriver(new URL(mobileProperties.getProperty("mintHost")), desiredCapabilities);
                        System.out.println("\n Fastest Connection Successful.....!");
                        ExtentCucumberAdapter.addTestStepLog("Fastest Connection Successful");
                        System.out.println("Wait for Device to Load up");
                        Thread.sleep(5000);
                    } catch (MalformedURLException e) {
                        System.out.println("\n Fastest Connection Not Successful.....!");
                        ExtentCucumberAdapter.addTestStepLog("Fastest Connection Not Successful");
                        e.printStackTrace();
                    }
                    break;
