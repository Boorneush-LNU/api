...
public class Web_CreatePassword {
    ...
    private final By showPasswordBtn = By.xpath("//input[@id='txtPassword']/following-sibling::button");
    ...
    public void enterPassword() throws InterruptedException {
        try {
            webUtil.sendKeys(enterPassword, REGISTRATION_DATA.getPassword());
//                webUtil.sendKeys(enterPassword, "MyAccount_2021");
    ...
    public void clickShowPassword() throws Exception {
        try {
            ...
            throw new ExceptionUtils("Not Clicked on Show Password");
        }
    }
...
//            webUtil.scrollToView(completeBtn);
//            Thread.sleep(5000);
    ...
    public void enterPasswordWebTitle() {
        try {
            webUtil.sendKeys(enterPassword,  regstrnData.get("Password1"));
