...
public class WebSecurityCode extends MasterStepDefs {
    ...
    private void verifycontentSecurity()  {
    ...
    public void enterSecuritycodeforweb(String number) throws Exception {
        //String otp = apiUtil.getOTP(otpUrl, 200, "0".concat(Expedited.testData.get("20-8007008")));
        String otp = apiUtil.getOTP(otpUrl, 200,"0".concat(number));
    ...
    public void validateOTPErrorMessage(String feildType) {

        switch (feildType){
            case "Blank":
                webUtil.sendKeys(enterCode,"");
                clickConfirmBtn();
                webUtil.gettextlog(By.id("errorVerificationRequiredMessage"),String::equals,"Please enter your verification code.");
                break;
            case "Expired":
                webUtil.sendKeys(enterCode,"123456");
                clickConfirmBtn();
                webUtil.gettextlog(By.id("errorVerificationAPIMessage"),String::equals,"Verification code is invalid or has expired. Please try again.");
            case "Invalid":
                webUtil.sendKeys(enterCode,"12");
                clickConfirmBtn();
                webUtil.gettextlog(By.id("errorVerificationMessage"),String::equals,"Please enter the six-digit verification code sent to your registered mobile number.");
