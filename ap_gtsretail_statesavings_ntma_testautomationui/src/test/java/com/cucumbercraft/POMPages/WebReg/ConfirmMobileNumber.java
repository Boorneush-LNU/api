...
//    private final String actualMobileNumber = REGISTRATION_DATA.getPrefix().concat(" ").concat(REGISTRATION_DATA.getMobileNumber());
...
//        webUtil.gettextlog(mobileNumber, String::equalsIgnoreCase, actualMobileNumber);
    ...
    public void clickSendCode() throws Exception {
