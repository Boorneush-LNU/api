...
public class Change_IBAN {
    ...
    private By invalidIBAN = By.id("iban-custom-error");
    //    Securtity page
    ...
    private final By didNotReceiveCodeonIbanSlider = By.xpath("//a[@onclick='ShowResendCode()']");
...
//                ExtentCucumberAdapter.addTestStepScreenCaptureFromPath(Util.takeScreenshotFile(driver));
     ...
     * @throws Exception
     */
    public void error(String ibanType,String expectedMessage)  {
        if (ibanType.contains("Blank")) {

                enterValueForIBAN = By.id("iban-required-error");

            webUtil.gettextlog(enterValueForIBAN, String::equals, expectedMessage);

        } else if (ibanType.contains("Invalid")) {

            webUtil.gettextlog(invalidIBAN, String::equals, expectedMessage);

        } else if (ibanType.contains("Non-Sepa")) {

                invalidIBAN = By.id("iban-server-error");

            webUtil.gettextlog(invalidIBAN, String::equals, expectedMessage);
        } else if (ibanType.contains("Consent Error")) {

                confirmConsent = By.id("iban-conform-error");
...
//        System.out.println(num);
    ...
    public void userClickOnCodeNotReceivedIban() {

        webUtil.click(didNotReceiveCodeonIbanSlider);
