...
public class Add_IBAN {
    ...
    private final By cancelBtn = By.xpath("//button[@class='gtm-cta button button--secondary button--alt js-closeModal'][normalize-space()='Cancel']");
    ...
    public final By addIBANOtpSlider = By.xpath("//section[@data-name='one-time-security-code-pin-request-modal']");
    ...
    public final By addIBANSlider = By.id("sectionConfirmChangeIban");
...
//        webUtil.click(cancelBtn);
        webUtil.waitUntilElementVisible(addIBANSlider,10).findElement(SliderContent.CLOSE_SLIDER);
    }
