...
public class ExpeditedModals {
    ...
    private final By reqExceededHdr = By.cssSelector("#sectionExceeded h4");
    private final By reqExceededPara1 = By.cssSelector("#sectionExceeded p:nth-of-type(1)");
    private final By reqExceededPara2 = By.cssSelector("#sectionExceeded p:nth-of-type(2)");
    ...
    private final String expReissuePara2 = "To register for Ireland State Savings Online you must complete the full registration process. Select ‘Continue Registration’ below to proceed.";
    private final By reissueCancel = By.cssSelector("#sectionExceeded div button");
    private final By reissueContiReg = By.cssSelector("#sectionExceeded div a");
    ...
    private void verifyReissuePIN() throws Exception {
            ...
            webUtil.gettextlog(reqExceededHdr,String::equals,expReissueHeader);
            webUtil.gettextlog(reqExceededPara1,String::equals,expReissuePara1);
            webUtil.gettextlog(reqExceededPara2,String::equals,expReissuePara2);
