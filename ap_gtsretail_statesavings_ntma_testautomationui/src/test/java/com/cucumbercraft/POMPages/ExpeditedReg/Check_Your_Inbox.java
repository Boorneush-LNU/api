...
public class Check_Your_Inbox extends MasterStepDefs {
    ...
    private final String firstPoint = "Allow 1-2 minutes for the email to be received.";
    ...
    private final By resendEmail = By.xpath("//button[@class='gtm-linkclick button button--primary']");
    private final By closeBtn = By.xpath("//button[@class='gtm-linkclick button button--secondary button--alt js-closeModal']");
    private final By resendSuccessfully = By.cssSelector(".notification-box__text strong");
