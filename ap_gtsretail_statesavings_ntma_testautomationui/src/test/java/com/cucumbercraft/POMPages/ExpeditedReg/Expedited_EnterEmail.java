...
public class Expedited_EnterEmail {
    ...
    private static final Logger log = LogManager.getLogger(Expedited_EnterEmail.class);

    private final By checkemaildidnotreceivelink = By.xpath("//a[@href='Javascript:void(0);']");
    ...
    private final By securitycodedidnotreceivelink = By.xpath("//button[contains(@class, 'js-modalTrigger')]");
    ...
    public void enterEmailAddress() throws InterruptedException {
        ...
        webUtil.sendKeys(enterEmail, REGISTRATION_DATA.getEmailAddress());

    }

    public void reEnterEmailAddress() throws InterruptedException {

        webUtil.sendKeys(reEnterEmail, REGISTRATION_DATA.getReEnterEmailAddress());

    }

    public void clickCheckEmailCodeNotReceivedLink() {
        webUtil.click(checkemaildidnotreceivelink);
    }


    public void checkConsent() throws InterruptedException {
//        if (!REGISTRATION_DATA.getEmailAddress().equalsIgnoreCase("")) {
...
//        }
    ...
    public void MobileSecurityCodeNotReceivedLink() {
        webUtil.click(securitycodedidnotreceivelink);
    }
    ...
    public void enterEmailAddressforTitle() throws InterruptedException {
        ...
        webUtil.sendKeys(enterEmail,  regstrnData.get("EmailAddress"));
        webUtil.sendKeys(reEnterEmail, regstrnData.get("Re-EnterEmailAddress"));
