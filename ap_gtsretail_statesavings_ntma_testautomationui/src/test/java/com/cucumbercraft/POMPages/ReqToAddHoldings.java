...
public class ReqToAddHoldings {
    ...
    public By thanksFormCloseButton = By.xpath("//section[@regstrnData-name='add-missing-product-thank-you-modal']//button[@aria-label='Close modal']");
    ...
    public SliderContent clickConfirmAndDownloadForm() {
        webUtil.click(confirmDownloadForm);
